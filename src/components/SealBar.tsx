...
export const SealBar: React.FC = () => {
  ...
  return (
    <footer
      ...
      className="fixed bottom-[52px] md:bottom-0 left-0 right-0 z-30 bg-[var(--bg-surface)] border-t border-keepeit px-4 py-1.5 flex flex-wrap items-center justify-between gap-2 text-[11px] font-mono-label select-none shadow-lg transition-all"
    >
