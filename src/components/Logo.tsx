...
export const Logo: React.FC<LogoProps> = ({ className = '', size = 'md' }) => {
  ...
  return (
    <div
      className={`inline-flex items-center justify-center bg-[var(--accent-seal)] text-[var(--accent-fg)] border border-keepeit rounded-keepeit shrink-0 shadow-xs ${containerSize} ${className}`}
    >
      <svg
